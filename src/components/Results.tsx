...
export default function Results({ endGameState, targetWord }: Props) {
    ...
    <>
      ...
      <div className="flex my-14 py-6 w-3/4 justify-center items-center border-yellow border-y-2">
        <div className="flex-1 flex justify-center items-center">
          ...
          {/* <div
            id="social-status"
            className="shadow-lg shadow-gray-300 select-none cursor-pointer leading-5 border border-gray-400 rounded-md"
            style="flex-shrink: 0"
          ></div> */}
        </div>

        <div className="flex-1 flex flex-col justify-center items-start pl-4">
          <p id="share-text">Dalinkis rezultatu</p>
          <p className="py-1"></p>
          <img
            src={arrowIcon}
            alt=""
